...
pub fn diff_associative_key(a: kalai::BValue, b: kalai::BValue, k: kalai::BValue) -> kalai::BValue {
    ...
    let vec_18730: kalai::BValue = diff(va.clone(), vb.clone());
    let aa: kalai::BValue = {
        let get1 = get(vec_18730.clone(), kalai::BValue::from(0i64));
    ...
    let bb: kalai::BValue = {
        let get2 = get(vec_18730.clone(), kalai::BValue::from(1i64));
    ...
    let ab: kalai::BValue = {
        let get3 = get(vec_18730.clone(), kalai::BValue::from(2i64));
...
pub fn vectorize(m: kalai::BValue) -> kalai::BValue {
    if not_empty(m.clone()) {
        return reduce(
            |result, p_18772| {
                let vec_18774 = p_18772.clone();
                let k: kalai::BValue = {
                    let get4 = get(vec_18774.clone(), kalai::BValue::from(0i64));
                ...
                let v: kalai::BValue = {
                    let get5 = get(vec_18774.clone(), kalai::BValue::from(1i64));
